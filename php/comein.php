...
defined('STATIC_URL') || define('STATIC_URL', '192.168.10.128:9091');//静态文件网络url
...
if(file_exists(API_PATH . $service . ".service")) {// 加载 controller
...
//		$loadClass -> run();
	...
	header(STATIC_URL.'/404'.TEMPLATE_EXT);
}
